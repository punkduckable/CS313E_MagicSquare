...
Description: This code uses the algorithm provided in the problem statement to
generate an nxn magic square (where n >=3). In addition, the code prints the
square generated by the algorithm and checks that the square is indeed magic.
